...
" Heartbeat publication is never skipped.");
    ...
    readonly HashSet<VectorThrust> aimedNacelles =
        new HashSet<VectorThrust>(),availableNacelles =
...
"Greedy",
    ...
    sealed class ScanSnapshot
    {
        ...
        public readonly List<Thruster> Thrusters =
            ...
            new List<Thruster>(),RemoteReduxThrusters =
            new List<Thruster>(),RemoteUnmanagedThrusters =
            new List<Thruster>(),RemoteFixedReduxThrusters =
            new List<Thruster>();

        public readonly List<Rotor> RotorCandidates =
            new List<Rotor>(),ControlledRotors =
            new List<Rotor>();
...
"0.###"))
    ...
    readonly List<IMyTerminalBlock> topologyFingerprintBlocks =
        new List<IMyTerminalBlock>(),topologyFingerprintGroupBlocks =
        new List<IMyTerminalBlock>();
    ...
    const ulong TopologyHashOffset =
        14695981039346656037UL,TopologyHashPrime =
        1099511628211UL;
